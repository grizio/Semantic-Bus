...
// @ts-ignore - because of import system, same for all
let userModel = require("../models/user_model");
// @ts-ignore
let workspaceModel = require("../models/workspace_model");
let pattern = require("../helpers/index").patterns;
// @ts-ignore
...
// @ts-ignore
let historiqueModel = require("../models/index").historiqueEnd;
// --------------------------------------------------------------------------------
// --------------------------------------------------------------------------------
...
// @ts-ignore TS2451: Cannot redeclare block-scoped variable 'decimalAdjust'.
