module.exports = {
  ...
  checkWorkspaceComponentConsistency: function(workspaceComponentsList, callback) {
    ...
    for (let workspaceComponentKey in workspaceComponentsListDictionnary) {
      var workspaceComponent = workspaceComponentsListDictionnary[workspaceComponentKey];
      for (let connectionAfter of workspaceComponent.connectionsAfter) {
      ...
      for (let connectionBefore of workspaceComponent.connectionsBefore) {
