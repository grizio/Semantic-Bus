let user_model = require("../lib/core/models/index").user;
let workspace_model = require("../lib/core/models/index").workspace;
let workspaceComponent_model = require("../lib/core/models/index").workspaceComponent;
// @ts-ignore
let historiqueModel = require("../lib/core/models/index").historique;
// @ts-ignore
let cache_model = require("../lib/core/models/index").cache;
// @ts-ignore
...
function workspaceGraph(userId) {
  return new Promise((resolve, reject) => {
    historiqueModel.aggregate(
      [
        {
